      ...
      <div class="head">
          ...
          <a href="index.php"><img class="bol" src="shared/jeverus.png" alt="bol"></a>
            ...
            <nav>
                ...
                <ul>
                    <li><a href="register.php" id="page">Register</a></li>
...
<br><div class="createaccount"><h1>Register to create custom bookmarks.</h1></div><br><br>


<form method="post" action="home.php">

<div ><input required type="text" id="first-name" name="first-name" class="names" placeholder="First Name" /></div>
<div ><input required type="text" id="last-name" name="last-name" class="names" placeholder="Last Name" /></div>
<div ><input required type="email" id="email" name="email" class="names" placeholder="Email" /></div>
<div ><input required type="password" id="password" name="password" class="names" placeholder="Password" /></div>
<div ><input required type="password" id="confirmation" name="confirmation" class="names" placeholder="Password Confirmation" /></div><br>
<div ><input type="button" class="button2" value="Register" /></div>
