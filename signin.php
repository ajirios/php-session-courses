          ...
          <a href="index.php"><img class="bol" src="shared/jeverus.png" alt="bol"></a>
            ...
            <nav>
                ...
                <ul>
                    ...
                    <li><a href="signin.php" id="page" >Sign In</a></li>
                </ul>
...

{
    ...
    <div class="right">
        ...
        <br><br><div class="createaccount"><h1>Sign in to create custom bookmarks.</h1></div><br><br>


        <form id="sign-in-form" method="post" action="home.php">

            <input required type="email" id="email" name="email" class="names" placeholder="Email" />
            <input required type="password" id="password" name="password" class="names" placeholder="Password" /><br>
            <input type="button" class="button2" onclick="submit()" value="Sign In" />
